...
<html xmlns="http://www.w3.org/1999/xhtml">
				...
				<td>
					<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
						<tr align="left" bgcolor="#F2FDFF">
							<td colspan="17" background="images/table_header.gif">加入社团列表</td>
						</tr>
					</table>
				</td>
			</tr>
			  ...
			  <table width="100%" border="1" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
					...
					<tr align="right" bgcolor="#ebf0f7">
					  ...
					  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
						<tr align="left" >
							<td colspan="17">
								<form action="jiarushetuanList2.do" name="myform" method="post">
    ...
    <td  width='80' align='center' bordercolor="#F3F3F3">是否审核</td>
    ...
    <td bordercolor="#F3F3F3">${u.issh}
                    <input type="button" value="审核" onclick="javascript:location.href='sh3.jsp?id=${u.id}&amp;yuan=${u.issh}&amp;tablename=jiarushetuan'"/></td>
                              <td height="45" align="center"> ${u.addtime } </td>
                              <td height="45" align="center"> <a class="btn btn-info btn-small" href="deleteJiarushetuan.do?id=${u.id }" onClick="{if(confirm('确定要删除吗?')){return true;}return false;}">删除</a> <a class="btn btn-info btn-small" href="doUpdateJiarushetuan.do?id=${u.id }">编辑</a>  <a class="btn btn-info btn-small" href="jiarushetuanDetail.do?id=${u.id }">详细</a></td>
                            </tr>
                          </c:forEach>
                        </table></td>
						</tr>
		 ...
		 <c:if test="${page.page>1}">
              <a href="jiarushetuanList2.do?page=1" >首页</a>
             <a href="jiarushetuanList2.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="jiarushetuanList2.do?page=${page.page+1 }">下一页</a>
			<a href="jiarushetuanList2.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
