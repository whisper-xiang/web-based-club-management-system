	...
	<body>
			<form action="updateShetuanhuodong.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						...
						<script language="javascript">document.form1.yonghuming.value='${shetuanhuodong.yonghuming}';</script>	<script language="javascript">document.form1.xingming.value='${shetuanhuodong.xingming}';</script>	<script language="javascript">document.form1.shetuanmingcheng.value='${shetuanhuodong.shetuanmingcheng}';</script>	<script language="javascript">document.form1.shetuanleixing.value='${shetuanhuodong.shetuanleixing}';</script>	<script language="javascript">document.form1.huodongzhuti.value='${shetuanhuodong.huodongzhuti}';</script>	<script language="javascript">document.form1.huodongdidian.value='${shetuanhuodong.huodongdidian}';</script>	<script language="javascript">document.form1.huodongshijian.value='${shetuanhuodong.huodongshijian}';</script>	<script language="javascript">document.form1.haibao.value='${shetuanhuodong.haibao}';</script>	<script language="javascript">document.form1.jianjie.value='${shetuanhuodong.jianjie}';</script>	
					 </table>
			</form>
   </body>
</html>
