...
<html xmlns="http://www.w3.org/1999/xhtml">
			  ...
			  <table width="100%" border="1" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
					...
					<tr align="right" bgcolor="#ebf0f7">
					  ...
					  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
						<tr align="left" >
							<td colspan="17">
								<form action="huodongbaomingList2.do" name="myform" method="post">
    ...
    <td bordercolor="#F3F3F3">${u.issh}
                    <input type="button" value="审核" onclick="javascript:location.href='sh3.jsp?id=${u.id}&amp;yuan=${u.issh}&amp;tablename=huodongbaoming'"/></td>
                              <td height="45" align="center"> ${u.addtime } </td>
                              <td height="45" align="center"> <a class="btn btn-info btn-small" href="deleteHuodongbaoming.do?id=${u.id }" onClick="{if(confirm('确定要删除吗?')){return true;}return false;}">删除</a> <a class="btn btn-info btn-small" href="doUpdateHuodongbaoming.do?id=${u.id }">编辑</a>  <a class="btn btn-info btn-small" href="huodongbaomingDetail.do?id=${u.id }">详细</a></td>
                            </tr>
                          </c:forEach>
                        </table></td>
						</tr>
		 ...
		 <c:if test="${page.page>1}">
              <a href="huodongbaomingList2.do?page=1" >首页</a>
             <a href="huodongbaomingList2.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="huodongbaomingList2.do?page=${page.page+1 }">下一页</a>
			<a href="huodongbaomingList2.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
