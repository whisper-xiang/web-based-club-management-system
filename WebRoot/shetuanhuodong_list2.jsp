				...
				%>
                            <tr align="center" bgcolor="#FFFFFF">
                             ...
                             <td>${u.yonghuming}</td>    <td>${u.xingming}</td>    <td>${u.shetuanmingcheng}</td>    <td>${u.shetuanleixing}</td>    <td>${u.huodongzhuti}</td>    <td>${u.huodongdidian}</td>    <td>${u.huodongshijian}</td>    <td width='90' align='center' bgcolor='#ebf0f7'><a href='${u.haibao}' target='_blank'><img src='${u.haibao}' width=88 height=99 border=0 /></a></td>        <td align='center'>${u.issh} </td>
                              ...
                              <td height="45" align="center"> <a class="btn btn-info btn-small" href="deleteShetuanhuodong.do?id=${u.id }" onclick="{if(confirm('确定要删除吗?')){return true;}return false;}">删除</a> <a class="btn btn-info btn-small" href="doUpdateShetuanhuodong.do?id=${u.id }">编辑</a>  <a class="btn btn-info btn-small" href="sthdDetail.do?id=${u.id }" target="_blank">详细</a></td>
                            </tr>
                          </c:forEach>
                        </table></td>
						</tr>
