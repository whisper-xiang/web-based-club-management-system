...
public class IndexController {
	...
	@Resourceprivate ShetuanhuodongServer shetuanhuodongServer;@Resourceprivate ShetuanxinxiServer shetuanxinxiServer;
...
//	首页显示内容
	...
	public String showIndex(ModelMap map){
		...
		List<Shetuanhuodong> syshetuanhuodong=shetuanhuodongServer.getsyshetuanhuodong1(null);List<Shetuanxinxi> syshetuanxinxi=shetuanxinxiServer.getsyshetuanxinxi1(null);
	    ...
	    map.put("syshetuanhuodong", syshetuanhuodong);map.put("syshetuanxinxi", syshetuanxinxi);
